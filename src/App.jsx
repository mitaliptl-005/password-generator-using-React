...
function App() {
 ...
 useEffect(() => {
  ...
  return (
    <>
    <div className='w-full max-w-md px-4 mx-auto my-8 text-orange-500 bg-gray-200 rounded-lg shadow-md'>
      ...
      <div className='flex mb-4 overflow-hidden rounded-lg shadow'>
        ...
        bg-blue-400 text-black px-3 py-0.5 shrink-0'>Copy</button>
      </div>
